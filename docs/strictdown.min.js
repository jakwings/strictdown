...
g+m(e[0].replace(L,"$1")):g+"\\\n";continue a}break;case "strong":case "em":case "del":if(e=p.exec(b))if(e[2]||e[4]||2!==e[1].length||e[1].length!==e[5].length)b=b.substr(e[1].length),g+=e[1];else{b=b.substr(e[0].length);if(d){g=this.wrap(g,null,!0);g+=this.translate(e[3],null,!0);c+=g;g="";continue a}g=this.wrap(this.abbr(m(g,!0)),f);g="strong"===h?g+("<strong>"+this.translate(e[3])+"</strong>"):"em"===h?g+("<em>"+this.translate(e[3])+"</em>"):g+("<del>"+this.translate(e[3])+"</del>");c+=g;g="";
continue a}break;case "verbatim":if(e=p.exec(b))if(p=!0,e[4]=e[4]||"",e[5]=e[5]||"",!e[2]||"`"===e[2]||1<e[1].length&&(2>e[3].length||e[5])?p=!1:1===e[1].length&&(1===e[3].length&&/^(?:\\[`\\]|[^`\\])+$/.test(e[2])||(p=!1)),p){b=1!==e[1].length?b.substr(e[0].length):b.substr(e[1].length+e[2].length+e[3].length);if(d){g=this.wrap(g,null,!0);g=1===e[1].length?g+this.wrap(e[2].replace(/\\([\\`])/g,"$1"),null,!0):g+this.wrap(e[2],null,!0);c+=g;g="";continue a}g=this.wrap(this.abbr(m(g,!0)),f);1===e[1].length?
(p=e[2].replace(/\\([\\`])/g,"$1"),g+='<span class="'+r.generalPrefix+'literal">'+this.wrap(this.abbr(m(p)))+"</span>"):(a="",e[4]&&(a=e[4].replace(D,"$1"),r.sanitize&&(a=a.replace(/  */g,"-")),a=' class="'+r.languagePrefix+m(a)+'"'),p=e[2]+e[3].slice(0,0-e[1].length),g+="<code"+a+">"+this.wrap(this.abbr(m(p)))+"</code>");c+=g;g="";continue a}else b=b.substr(e[1].length),g+=e[1];break;case "link":if((e=p.exec(b))&&!(e[2]||e[4]||e[6])){b=b.substr(e[0].length);if(d){g=this.wrap(g,null,!0);g+=this.translate(e[1],
null,!0);c+=g;g="";continue a}g=this.wrap(this.abbr(m(g,!0)),f);p=e[1];a=(e[3]||"").replace(D,"$1");h=(e[5]||"").replace(D,"$1");e="";if(h)h=m(this.shapeUri(this.wrap(h,null,!0)));else switch(a=this.wrap(a,null,!0),a.charAt(0)){case "^":a=a.substr(1).toLowerCase();this.notes[a]&&(h="#"+r.generalPrefix+"footnote-"+this.notes[a].index);break;case "@":a=a.substr(1).toLowerCase();this.images[a]&&(h=m(this.shapeUri(this.images[a].href)),e=m(this.images[a].title));break;case "*":a=a.substr(1).toLowerCase();
h="#"+r.generalPrefix+"anchor-"+m(a);e=m(a);break;default:a=(a||this.translate(p,null,!0)).toLowerCase(),this.links[a]&&(h=m(this.shapeUri(this.links[a].href)),e=m(this.links[a].title))}g+='<a class="'+r.generalPrefix+'ref-link"'+(h?' href="'+h+'"':"")+(e?' title="'+e+'"':"")+">"+this.translate(p)+"</a>";c+=g;g="";continue a}break;case "autolink":if((e=p.exec(b))&&!e[2]){if(d){g=this.wrap(g,null,!0);p=this.wrap(e[1].replace(D,"$1"),null,!0);g=/^[@:^]/.test(p)?g+p.substr(1):g+p;c+=g;g="";continue a}b=
b.substr(e[0].length);g=this.wrap(this.abbr(m(g,!0)),f);a=this.wrap(e[1].replace(D,"$1"),null,!0);p=e=h="";switch(a.charAt(0)){case "@":p="raw";a=a.substr(1).toLowerCase();this.images[a]&&(h=m(this.shapeUri(this.images[a].href,!0)),e=m(this.images[a].title),a=h);break;case ":":p="raw";a=a.substr(1).toLowerCase();this.links[a]&&(h=m(this.shapeUri(this.links[a].href,!0)),e=m(this.links[a].title),a=h);break;case "^":p="ref";a=a.substr(1);this.notes[a.toLowerCase()]&&(h="#"+r.generalPrefix+"footnote-"+
this.notes[a.toLowerCase()].index,a=m(a));break;default:!/^[^ \n][^ \n]*@[^ \/\n][^ \/\n]*$/.test(a)||/^[A-Za-z][+\-.0-9A-Za-z]*:/.test(a)?(p="raw",a=h=m(this.shapeUri(a,!0))):(p="mail",a=a.replace(/./g,function(a){return"&#"+a.charCodeAt(0)+";"}),h="mailto:"+a)}g+='<a class="'+r.generalPrefix+p+'-link"'+(h?' href="'+h+'"':"")+(e?' title="'+e+'"':"")+">"+a+"</a>";c+=g;g="";continue a}break;case "footnote":if((e=p.exec(b))&&!e[2]){b=b.substr(e[0].length);if(d){g=this.wrap(g,null,!0);c+=g;g="";continue a}g=
this.wrap(this.abbr(m(g,!0)),f);a=this.wrap(e[1].replace(D,"$1"),null,!0);p=0;this.notes[a]&&(p=this.notes[a].index,this.notes[a].refs.push(++this.refIndex));g+="<a"+(p?' id="'+r.generalPrefix+"ref-footnote-"+this.refIndex+'"':"")+' class="'+r.generalPrefix+'ref-footnote"'+(p?' href="#'+r.generalPrefix+"footnote-"+p+'"':"")+"><sup>"+p+"</sup></a>";c+=g;g="";continue a}break;case "image":if((e=p.exec(b))&&!(e[2]||e[4]||e[6])){b=b.substr(e[0].length);if(d){g=this.wrap(g,null,!0);g+=this.wrap(e[1].replace(D,
"$1"),null,!0);c+=g;g="";continue a}g=this.wrap(this.abbr(m(g,!0)),f);p=this.wrap(e[1].replace(D,"$1"),null,!0);a=(e[3]||"").replace(D,"$1");h=(e[5]||"").replace(D,"$1");var n=e="",u="",q="";h?h=m(this.shapeUri(this.wrap(h,null,!0))):(a=this.wrap(a,null,!0).toLowerCase(),this.images[a]&&(h=this.shapeUri(this.images[a].href),e=this.images[a].title,n=this.filterCss(this.images[a].width),u=this.filterCss(this.images[a].height),q=this.images[a].align));a="";r.stylish&&(n||u)&&(a=' style="'+(q?"float:"+
m(q)+";":"")+(n?"width:"+m(n)+";":"")+(u?"height:"+m(u)+";":"")+'"');g+='<img src="'+m(h)+'"'+(p?' alt="'+m(p)+'"':"")+(e?' title="'+m(e)+'"':"")+(!r.stylish&&q?' align="'+q+'"':"")+(r.stylish?a:(n?' width="'+m(n)+'"':"")+(u?' height="'+m(u)+'"':""))+(r.xhtml?"/>":">");c+=g;g="";continue a}break;case "anchor":case "ref":if((e=p.exec(b))&&!e[2]){b=b.substr(e[0].length);if(d){g=this.wrap(g,null,!0);g+=this.translate(e[1],null,!0);c+=g;g="";continue a}g=this.wrap(this.abbr(m(g,!0)),f);p=e[1];a=this.translate(p,
null,!0).replace(/  */g,"-").toLowerCase();g="anchor"===h?g+('<a class="'+r.generalPrefix+'anchor" id="'+r.generalPrefix+"anchor-"+m(a)+'"></a>'+this.translate(p)):g+('<a class="'+r.generalPrefix+'ref-anchor" href="#'+r.generalPrefix+"anchor-"+m(a)+'">'+this.translate(p)+"</a>");c+=g;g="";continue a}break;case "comment":case "tag":if(e=p.exec(b)){b=b.substr(e[0].length);if(d)continue a;g=this.wrap(this.abbr(m(g,!0)),f);c+=g+e[0];g="";continue a}break;default:throw Error('Format "'+h+'" does not have a handler.');
}}g+=b.charAt(0);b=b.substr(1)}g&&(c=d?c+this.wrap(g,null,!0):c+this.wrap(this.abbr(m(g,!0)),f));return c};A.prototype.wrap=function(b,f,d){if(this.nowrap)return b;var a=this.options;switch(a.wrappingMode){case "default":b=d?b.replace(/\\\n/g,"\r").replace(/\n/g," ").replace(/\r/g,"\n"):b.replace(/\\\n/g,a.xhtml?"<br/>":"<br>").replace(/\n/g," ");break;case "break":d||(b=b.split("\n").join(a.xhtml?"<br/>\n":"<br>\n"));break;case "paragraph":d||(b=f?b.split("\n").join("</p>\n<p>"):b.split("\n").join(a.xhtml?
